...
<template>
  ...
  <p class="text-base text-gray-900 p-4">
    В этом разделе я веду учёт прочитанной технической литературы (за последние пару лет), и планирую, что
    читать следующим – это мотивирует читать больше, и качественнее! Полный
    <a
      href="http://library.hazadus.ru/lists/5/details/"
      class="underline"
      >бэклог веду</a
    >
    на своём книжном сайте – там полный перечень отборных книг, а не только на ближайшее время. Если вам
    интересно обсудить какие-то из перечисленных книг, обязательно
    <NuxtLink
      to="/about/#contacts"
      class="underline"
      >выходите на связь</NuxtLink
    >! Кроме того, буду рад рекомендациям хорошей технической литературы.
  </p>
