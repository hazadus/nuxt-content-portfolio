...
const { data: topIssues, error: issuesError } =
  await fetchLatestOpenIssuesInfo();
</script>
...
<template>
  ...
  <section class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-4">
    ...
    <div class="p-4 bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <ul class="text-sm">
        ...
        <li>
          <a href="https://track.toggl.com/" class="hover:underline">
            Toggl Track
          </a>
        </li>
      </ul>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <ul class="text-sm">
        ...
        <li>
          <Icon name="logos:firebase" class="mr-1" />
          <a href="https://console.firebase.google.com/" class="hover:underline"
            >Firebase Console
          </a>
        </li>
      </ul>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <ul class="text-sm">
        ...
        <li>
          <a href="https://next-bredit.vercel.app/" class="hover:underline">
            Бредит
          </a>
        </li>
        <li>
  ...
  <AlertBox v-if="reposError || issuesError" alertType="warning" class="mt-4">
    <p>
      Произошла ошибка при обращении к GitHub API! Пожалуйста, обновите
      страницу.
    </p>
  ...
  <section class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
    ...
    >
      ...
      <ul class="text-sm">
        ...
        >
          <Icon name="octicon:issue-opened-16" class="mr-1" /><a
            :href="issue.url"
            class="hover:underline"
          >
            {{ issue.title }}
          ...
          <span class="text-gray-300">
            &nbsp;&middot;
            <a :href="issue.repository.url" class="hover:underline">{{
    ...
    >
      ...
      <ul class="text-sm">
        ...
        <li
          ...
          :key="`repo-${repo.id}`"
        >
          <Icon name="mdi:source-repository" class="mr-1" /><a
            :href="repo.url"
            class="hover:underline"
          >
            {{ repo.name }}
          ...
          <span class="text-gray-300"
            >&nbsp;&middot; {{ formatDateTime(repo.pushedAt) }}</span
          >
        </li>
      </ul>
    </div>
